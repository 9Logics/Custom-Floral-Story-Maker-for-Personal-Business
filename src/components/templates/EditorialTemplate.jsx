...
export default function EditorialTemplate({ products, brandName, ctaText, brandLogo, vintageTexture, vintageOverlay }) {
  ...
  if (count === 0) {
    return (
      <div className="w-full h-full flex items-center justify-center bg-[#1a1a1a] text-white p-6 text-center">
        <p style={{ fontFamily: 'Outfit, sans-serif' }} className="text-xl opacity-20 font-light">Add products</p>
      </div>
    );
  }
  ...
  return (
    <div className="w-full h-full bg-[#121212] flex flex-col p-6 font-sans text-[#fafafa] relative overflow-hidden">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-[400px] font-serif text-[#d4af37] opacity-[0.03] select-none pointer-events-none leading-none z-0" style={{ fontFamily: 'Cinzel, serif' }}>
        {watermarkLetter}
      </div>
