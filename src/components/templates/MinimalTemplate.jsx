          ...
          <div key={product.id || i} className="flex flex-col h-full group">
            ...
            <div className="flex flex-col">
              <div className="flex justify-between items-baseline border-b border-[#e5e5e5] pb-1.5 mb-1.5">
                ...
                <p className={`${count > 4 ? 'text-[11px]' : 'text-[14px]'} text-[#1a1a1a] font-black`} style={{ fontFamily: 'Tenor Sans, sans-serif' }}>{product.price ? `₹${product.price.replace('₹', '')}${product.unit ? ' ' + product.unit : ''}` : 'Price'}</p>
              </div>
